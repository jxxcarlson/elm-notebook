...
import Dict
import Evergreen.V76.Authentication
...
type alias FrontendModel =
    ...
    , users : List Evergreen.V76.User.User
    ...
    , currentUser : Maybe Evergreen.V76.User.User
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V76.Authentication.AuthenticationDict
    }
...
type ToBackend
    ...
    | UpdateUserWith Evergreen.V76.User.User
...
type ToFrontend
    ...
    | GotUsers (List Evergreen.V76.User.User)
    | GotNotebook Book
    | GotNotebooks (List Book)
    | SendMessage String
    | UserSignedIn Evergreen.V76.User.User Lamdera.ClientId
    | SendUser Evergreen.V76.User.User
