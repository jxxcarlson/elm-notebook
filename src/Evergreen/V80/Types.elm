...
type alias FrontendModel =
    ...
    , users : List Evergreen.V80.User.User
    ...
    , currentUser : Maybe Evergreen.V80.User.User
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V80.Authentication.AuthenticationDict
    }
...
type ToBackend
    ...
    | UpdateUserWith Evergreen.V80.User.User
...
type ToFrontend
    ...
    | GotUsers (List Evergreen.V80.User.User)
    | GotNotebook Book
    | GotNotebooks (List Book)
    | SendMessage String
    | UserSignedIn Evergreen.V80.User.User Lamdera.ClientId
    | SendUser Evergreen.V80.User.User
