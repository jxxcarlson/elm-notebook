module Evergreen.V95.Value exposing (..)
...
type alias EnvValues =
    Evergreen.V95.FastDict.Dict String Value


type alias Env =
    { currentModule : Elm.Syntax.ModuleName.ModuleName
    , functions : Evergreen.V95.FastDict.Dict Elm.Syntax.ModuleName.ModuleName (Evergreen.V95.FastDict.Dict String Elm.Syntax.Expression.FunctionImplementation)
    , values : EnvValues
...
type Value
    ...
    | Record (Evergreen.V95.FastDict.Dict String Value)
