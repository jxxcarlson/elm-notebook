...
type alias FrontendModel =
    ...
    , users : List Evergreen.V84.User.User
...
type alias BackendModel =
    ...
    , authenticationDict : Evergreen.V84.Authentication.AuthenticationDict
    }
...
type ToBackend
    ...
    | UpdateUserWith Evergreen.V84.User.User
...
type ToFrontend
    ...
    | GotUsers (List Evergreen.V84.User.User)
    | GotNotebook Book
    | GotNotebooks (List Book)
    | SendMessage String
    | UserSignedIn Evergreen.V84.User.User Lamdera.ClientId
    | SendUser Evergreen.V84.User.User
