module Evergreen.V98.Value exposing (..)
...
type alias EnvValues =
    Evergreen.V98.FastDict.Dict String Value


type alias Env =
    { currentModule : Elm.Syntax.ModuleName.ModuleName
    , functions : Evergreen.V98.FastDict.Dict Elm.Syntax.ModuleName.ModuleName (Evergreen.V98.FastDict.Dict String Elm.Syntax.Expression.FunctionImplementation)
    , values : EnvValues
...
type Value
    ...
    | Record (Evergreen.V98.FastDict.Dict String Value)
