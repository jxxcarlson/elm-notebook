module Evergreen.V90.Value exposing (..)
...
import Evergreen.V90.FastDict


type alias EnvValues =
    Evergreen.V90.FastDict.Dict String Value


type alias Env =
    { currentModule : Elm.Syntax.ModuleName.ModuleName
    , functions : Evergreen.V90.FastDict.Dict Elm.Syntax.ModuleName.ModuleName (Evergreen.V90.FastDict.Dict String Elm.Syntax.Expression.FunctionImplementation)
    , values : EnvValues
...
type Value
    ...
    | Record (Evergreen.V90.FastDict.Dict String Value)
