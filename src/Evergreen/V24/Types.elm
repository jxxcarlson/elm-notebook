...
type alias FrontendModel =
    ...
    , users : List Evergreen.V24.User.User
    , books : List Book
    , currentBook : Book
    , cellContent : String
...
type ToBackend
    ...
    | UpdateUserWith Evergreen.V24.User.User
...
type ToFrontend
    ...
    | GotUsers (List Evergreen.V24.User.User)
    | GotNotebook Book
    | GotNotebooks (List Book)
    | SendMessage String
    | UserSignedIn Evergreen.V24.User.User Lamdera.ClientId
