module Evergreen.V133.Value exposing (..)
...
import Evergreen.V133.FastDict


type alias EnvValues =
    Evergreen.V133.FastDict.Dict String Value


type alias Env =
    { currentModule : Elm.Syntax.ModuleName.ModuleName
    , functions : Evergreen.V133.FastDict.Dict Elm.Syntax.ModuleName.ModuleName (Evergreen.V133.FastDict.Dict String Elm.Syntax.Expression.FunctionImplementation)
    , values : EnvValues
...
type Value
    ...
    | Record (Evergreen.V133.FastDict.Dict String Value)
