...
type alias FrontendModel =
    ...
    , users : List Evergreen.V13.User.User
    , inputName : String
    , inputAuthor : String
    ...
    , books : List Evergreen.V13.LiveBook.Types.Book
    , currentBook : Evergreen.V13.LiveBook.Types.Book
    , cellContent : String
...
type alias NoteBookDict =
    Dict.Dict String Evergreen.V13.LiveBook.Types.Book
...
type alias BackendModel =
    ...
    , dataSetLibrary : Dict.Dict String Evergreen.V13.LiveBook.DataSet.DataSet
...
type FrontendMsg
    ...
    | TogglePublic
    | ClearNotebookValues
    | SetCurrentNotebook Evergreen.V13.LiveBook.Types.Book
    | CloneNotebook
    | PullNotebook
...
type ToBackend
    ...
    | RunTask
    | SendUsers
    | CreateDataSet Evergreen.V13.LiveBook.DataSet.DataSet
    | GetData Int String String
    | GetDataSetForDownload String
    | CreateNotebook String String
    | SaveNotebook Evergreen.V13.LiveBook.Types.Book
    | DeleteNotebook Evergreen.V13.LiveBook.Types.Book
    | GetClonedNotebook String String
    | GetPulledNotebook String String String String
    | UpdateSlugDict Evergreen.V13.LiveBook.Types.Book
    ...
    | UpdateUserWith Evergreen.V13.User.User
...
type ToFrontend
    ...
    | GotUsers (List Evergreen.V13.User.User)
    | GotData Int String Evergreen.V13.LiveBook.DataSet.DataSet
    | GotDataForDownload Evergreen.V13.LiveBook.DataSet.DataSet
    | GotNotebook Evergreen.V13.LiveBook.Types.Book
    | GotNotebooks (List Evergreen.V13.LiveBook.Types.Book)
    | SendMessage String
    | UserSignedIn Evergreen.V13.User.User Lamdera.ClientId
