module Evergreen.V94.Value exposing (..)
...
type alias EnvValues =
    Evergreen.V94.FastDict.Dict String Value


type alias Env =
    { currentModule : Elm.Syntax.ModuleName.ModuleName
    , functions : Evergreen.V94.FastDict.Dict Elm.Syntax.ModuleName.ModuleName (Evergreen.V94.FastDict.Dict String Elm.Syntax.Expression.FunctionImplementation)
    , values : EnvValues
...
type Value
    ...
    | Record (Evergreen.V94.FastDict.Dict String Value)
