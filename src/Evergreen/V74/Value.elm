module Evergreen.V74.Value exposing (..)
...
type alias EnvValues =
    Evergreen.V74.FastDict.Dict String Value


type alias Env =
    { currentModule : Elm.Syntax.ModuleName.ModuleName
    , functions : Evergreen.V74.FastDict.Dict Elm.Syntax.ModuleName.ModuleName (Evergreen.V74.FastDict.Dict String Elm.Syntax.Expression.FunctionImplementation)
    , values : EnvValues
...
type Value
    ...
    | Record (Evergreen.V74.FastDict.Dict String Value)
