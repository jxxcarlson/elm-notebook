...
singletonTest =
    let
        ...
        singleton : InternalDict Key Value
        singleton =
...
insertTest =
    let
        insertFuzzer : Fuzzer ( Key, Value, InternalDict Key Value )
        insertFuzzer =
            Fuzz.triple keyFuzzer valueFuzzer dictFuzzer

        insertedFuzzer : Fuzzer (InternalDict Key Value)
        insertedFuzzer =
...
updateTest =
    let
        updateFuzzer : Fuzzer ( Key, InternalDict Key Value )
        updateFuzzer =
            Fuzz.pair keyFuzzer dictFuzzer

        updatedFuzzer : Fuzzer (InternalDict Key Value)
        updatedFuzzer =
