...
import Internal exposing (InternalDict(..), InnerDict(..), NColor(..))
...
-}
respectsInvariants : InternalDict comparable value -> Test
...
-}
respectsInvariantsFuzz : Fuzzer (InternalDict comparable value) -> Test
...
hasCorrectSize : InternalDict comparable v -> Bool
...
isRootBlack : InternalDict comparable v -> Bool
...
blackHeight : InternalDict k v -> Maybe Int
...
isBst : InternalDict comparable v -> Bool
isBst (Dict _ dict) =
    let
...
noRedChildOfRedNode : InternalDict k v -> Bool
