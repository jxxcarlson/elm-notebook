module Internal exposing (InternalDict(..), InnerDict(..), NColor(..), VisitQueue, fromSortedList, unconsBiggest, unconsBiggestWhileDroppingGT)
...
-}
fromSortedList : ListWithLength ( comparable, v ) -> InternalDict comparable v
fromSortedList dacc =
    let
        len : Int
        len =
